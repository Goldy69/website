...
export default function Gallery(props: Props<{ category: Category, imgs: img[] }>) {
    ...
    return <>
        ...
        <div className=" font-lucky relative gap-2 grid grid-rows-[auto,1fr,auto] min-h-screen bg-cat bg-center bg-cover text-white">
            ...
            <main className='z-50 flex flex-col gap-4 p-4'>
        ...
        {imgUrl && <div className='fixed z-50 bg-gray-900/60 top-0 left-0 w-screen h-screen grid place-items-center text-white'>
